...
RUN yum install -y dbus python3-gi python3-pip psmisc dbus-x11 pygobject3-devel python36u pygobject3 pygobject3-devel python36-pip gobject-introspection gobject-introspection-devel
